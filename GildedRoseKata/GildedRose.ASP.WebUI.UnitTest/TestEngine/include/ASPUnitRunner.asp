...
<%
	...
	Private Function AddTestContainers()
		...
		For Each oTestContainer In m_dicTestContainer.Items()
			...
			If (sTestContainer = Request("cboTestContainers")) Then
	...
	Private Function AddTestMethods()
		...
		If (Request("cboTestContainers") <> ALL_TESTCONTAINERS And Request("cboTestContainers") <> "") Then
...
<%
	...
	Private Function BuildTestSuite()
		...
		If (Request("cmdRun") <> "") Then
			If (Request("cboTestContainers") = ALL_TESTCONTAINERS) Then
				For Each oTestContainer In m_dicTestContainer.Items()
