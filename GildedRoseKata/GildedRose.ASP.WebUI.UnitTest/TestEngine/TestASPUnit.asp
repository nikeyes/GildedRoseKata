...
<!-- #include virtual="GildedRose.ASP.WebUI.UnitTest/Dado_Un_Item_Cuando_Se_Actualiza_Tests.asp"-->
...
<%
	...
	oRunner.AddTestContainer New Dado_Un_Item_Cuando_Se_Actualiza_Tests
